...
\section{Experience}
  ...
  \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Developed the backend for an innovative "digital workspace" product—a platform for communication, task management, project coordination, and business process management.}
  ...
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeSubSubheadingLeftOneRow
        {\textit{Specialization}:}{Mechatronics and Robotics}
  \resumeSubHeadingListEnd
